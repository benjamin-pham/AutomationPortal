...
Added sections: "Output Language" promoted to its own top-level section with stronger enforcement language
...
**ALL** output produced by speckit commands MUST be written in **VIETNAMESE (Vietnamese)**.
This rule applies to every skill in the speckit suite:

| Skill | Output files | Language |
|-------|-------------|----------|
| `/speckit.specify` | `spec.md` | VIETNAMESE |
| `/speckit.clarify` | clarification questions (inline) | VIETNAMESE |
| `/speckit.plan` | `plan.md`, `research.md`, `data-model.md`, `contracts/` | VIETNAMESE |
| `/speckit.tasks` | `tasks.md` | VIETNAMESE |
| `/speckit.analyze` | analysis report (inline) | VIETNAMESE |
| `/speckit.implement` | progress messages, inline commentary | VIETNAMESE |
| `/speckit.checklist` | `checklist.md` | VIETNAMESE |

**Exceptions** (these remain in English regardless):
- File names and directory paths
- Code identifiers: variables, functions, classes, types, constants
- Terminal commands and shell syntax
- NuGet/npm package names and version strings

If a skill output is not in Vietnamese, it is NON-COMPLIANT with this constitution and MUST be regenerated.
...
- **Speckit output language**: All documents generated by speckit commands MUST be in Vietnamese
  (see "Output Language" section above).
...
**Version**: 1.0.2 | **Ratified**: 2026-04-01 | **Last Amended**: 2026-04-02
