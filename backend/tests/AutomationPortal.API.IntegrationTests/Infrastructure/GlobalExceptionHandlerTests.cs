...
using AutomationPortal.API.Extensions;
using AutomationPortal.Application.Exceptions;
using Microsoft.AspNetCore.Http;
using Microsoft.Extensions.Logging.Abstractions;

namespace AutomationPortal.API.IntegrationTests.Infrastructure;
...
public sealed class GlobalExceptionHandlerTests
{
    ...
    public async Task TryHandleAsync_UnhandledException_DoesNotExposeStackTrace()
    {
        ...
        responseJson.Should().NotContain("at AutomationPortal");
